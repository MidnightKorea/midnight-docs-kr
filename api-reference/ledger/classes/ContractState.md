...
컨트랙트의 상태로, 주로 컨트랙트에서 직접 접근 가능한 [data](#data)와 호출 가능한 [ContractOperation](ContractOperation.md)의 맵으로 구성됩니다. 키 목록은 [operations](#operations)로 접근하고, 개별 연산은 [operation](#operation)으로 읽고 [setOperation](#setoperation)으로 설정할 수 있습니다.
