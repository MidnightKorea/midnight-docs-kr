...
slug: zkp
title: Midnight 증명 시스템, Pluto Eris에서 BLS로 전환하다
authors: stev
tags: [zkp]
...
| **Transaction size**         | 6 kb / 증명                       | 5 kb / 증명                     |
| **Tx verification time**     | 12 ms / 증명                      | 6 ms / 증명                     |
...
재귀 증명은 고급 암호학 애플리케이션의 핵심이며, 두 시스템의 처리 방식이 다릅니다. Pluto Eris은 더 작은 circuit을 사용하지만 CPU 비용이 높아, 사용량이 늘면 연산 자원에 부담을 줄 수 있습니다. BLS12-381은 반대로 더 큰 circuit을 사용하면서 CPU 비용을 낮춥니다.
