...
title: Architecture Overview DUST and Network Usage
authors: stev
tags: [night, dust]
date: 2026-01-02
...
정적 잔액(예: "코인 5개를 보유하고 있다")을 가진 일반 암호화폐와 달리, Dust 잔액은 시간과 Night 토큰의 상태에 따라 동적으로 변합니다.
...
`DustRegistration`은 Night 키를 Dust 키에 연결합니다.
  ...
  * 등록은 순차적으로 이루어집니다.
  * 등록 트랜잭션이 *이전에 Dust를 생성하지 않던* Night 입력(즉, 이전 등록이 없었던)을 사용하는 경우, 시스템은 해당 입력이 *생성했을* Dust를 사용하여 가스 비용을 지불하도록 등록을 "소급"할 수 있습니다.
...
**DUST에 대한 개요를 확인했으니, GitHub의 [DUST 사양](https://github.com/midnightntwrk/midnight-ledger/blob/main/spec/dust.md)을 살펴보세요!**

**GitHub의 [코드](https://raw.githubusercontent.com/midnightntwrk/midnight-node/refs/heads/main/primitives/mainchain-follower/src/data_source/cnight_observation.rs)에 참여하세요!**