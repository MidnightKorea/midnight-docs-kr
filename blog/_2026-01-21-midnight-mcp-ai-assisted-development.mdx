...
title: "Midnight MCP - AI를 활용한 Compact 스마트 컨트랙트 개발"
authors: [Idris]
...
_Model Context Protocol_(MCP)은 AI 어시스턴트가 외부 도구와 데이터 소스에 접근할 수 있게 해주는 개방형 표준입니다. 훈련 데이터에만 의존하지 않고, 실시간 문서 조회, 코드베이스 검색, API 호출이 가능해집니다.
...
- 상태 변경에는 witness 함수가 필요하며, 직접 할당이 아닙니다.
