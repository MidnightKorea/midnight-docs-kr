...
Midnight는 다음 기본 Polkadot SDK RPC 메서드도 지원합니다:
...
:::note
일반적인 polkadot-sdk RPC 메서드의 최신 참조 목록은 [여기](https://polkadot.js.org/docs/substrate/rpc/)에서도 확인할 수 있습니다. Midnight는 이 목록과 부분적으로 겹치는 메서드를 구현하고 있습니다.
:::

### Partnerchain RPC

Midnight는 블록 생산자 및 사이드체인 통합과 관련된 partnerchain 전용 RPC 메서드도 노출합니다. 이러한 메서드는 합의 신호 조회, 최종성 정보 중계, 체인 간 조율 등을 위해 설계되었습니다.
