...
Midnight의 구현이 Bitcoin과 크게 다른 부분입니다. UTXO를 단순히 데이터베이스에서 "사용됨"으로 표시하는 대신, Midnight는 정교한 nullifier 집합 방식을 사용합니다.
...
* **가지치기 불필요**: Bitcoin과 달리, Midnight는 사용된 UTXO를 이력에서 제거하지 않음
