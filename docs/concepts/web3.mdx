...
Midnight은 ZK 기술 기반의 데이터 보호를 통해 사용자가 더 안전하게 smart contract를 배포할 수 있도록 하는 것이 목표입니다. Midnight의 ZKP는 Universally Composable한 프라이버시와 보안의 이론적 기반 위에 설계되었습니다.
