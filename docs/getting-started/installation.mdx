...
Midnight DApp을 배포하고 사용하려면 Midnight Node와 Indexer가 모두 필요합니다. 이들은 RPC endpoint로 제공되며 [최신 안정 릴리스](../../relnotes/overview#environments)에서 확인할 수 있습니다. 이후 튜토리얼에서 사용법을 다루며, [예제](../../category/examples) 섹션에서 전체 DApp 데모를 확인할 수 있습니다.
