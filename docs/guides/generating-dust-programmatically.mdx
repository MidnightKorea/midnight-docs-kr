...
DUST 생성이 활성화되면 지갑이 트랜잭션 수수료를 지불할 준비가 된 것입니다. [Midnight에 스마트 컨트랙트 배포하기](https://docs.midnight.network/guides/deploy-mn-app)를 탐색하거나, 자체 애플리케이션의 지갑 설정 흐름에 DUST 생성을 통합할 수 있습니다. [Awesome DApps 리포지토리](https://github.com/midnightntwrk/awesome-dapps)와 [Midnight 문서](https://docs.midnight.network/)에서 더 많은 정보를 확인하세요.
