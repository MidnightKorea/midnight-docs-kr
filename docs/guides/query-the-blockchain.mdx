...
sidebar_label: 블록체인 데이터를 조회하는 방법
...
[`@polkadot/api`](https://polkadot.js.org/docs/api/) 라이브러리는 Midnight을 포함한 Substrate 기반 블록체인 네트워크에 연결하기 위한 WebSocket 프로바이더(`WsProvider`)를 지원합니다.
