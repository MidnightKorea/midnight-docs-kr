...
SPO 요건을 충족한 후, Midnight Block Producer Committee에 후보자로 등록할 수 있습니다. 이 committee는 Cardano blockchain의 스마트 컨트랙트로 구현되어 있으며, 각 epoch에서 블록 생성을 위한 SPO의 교체 및 선정을 관리합니다. 등록은 Midnight 노드 소프트웨어에서 제공하는 간단한 CLI 명령어로 진행됩니다.
