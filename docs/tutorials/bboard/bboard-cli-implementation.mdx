...
:::info
로컬 Midnight 네트워크 설정에 대한 자세한 정보는 [Running a local network](/guides/networks-and-environments#running-a-local-network)를 참조하세요.
:::
...
:::info
`standalone` 런처는 로컬 머신에서 실행 중인 로컬 Midnight 네트워크에 연결합니다. 자세한 정보는 [Running a local network](/guides/networks-and-environments#running-a-local-network)를 참조하세요.
:::
</TabItem>
</Tabs>
