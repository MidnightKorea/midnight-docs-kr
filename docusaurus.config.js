...
const config = {
  ...
  themeConfig: {
    ...
    algolia: {
      ...
      apiKey: process.env.ALGOLIA_SEARCH_KEY || "placeholder_search_key",
    ...
    navbar: {
      logo: {
        alt: "Midnight Korea Logo",
        src: "img/midnight_korea_black.svg",
        srcDark: "img/midnight_korea_white.svg",
        href: "/",
      },
      items: [
